    ...
    function beanzFooter(): JSX.Element {
        return (
            <footer className="flex lg:container lg:mx-auto lg:py-6 underline text-sm text-gray-400 max-w-11xl mx-auto lg:px-8">
                <a className="lg:block hidden mr-4" href="https://twitter.com/heyskylark">@heyskylark.</a>
                <a className="lg:block hidden" href="https://twitter.com/aetherfloweth">@aetherfloweth.</a>
    ...
    function regularFooter(): JSX.Element {
        return (
            <footer className="flex container mx-auto py-6 underline text-sm text-gray-400 max-w-11xl px-8">
                <a className="mr-4" href="https://twitter.com/heyskylark">@heyskylark.</a>
                <a href="https://twitter.com/aetherfloweth">@aetherfloweth.</a>
            </footer>
        );
    }
